<template>
  <div class="bg-white dark:bg-GunMetal">
    <div class="max-w-7xl mx-auto py-24 px-4 sm:pt-48 sm:bp-24 sm:px-6 lg:px-8">
      <div class="relative">
        ...
        <div class="grid lg:grid-cols-3 grid-cols-1">
          <div class="grid grid-cols-1 lg:grid-cols-3 col-span-3">
            <!-- Contact information -->
            <div class="relative overflow-hidden py-10 px-6 bg-orange-50 dark:bg-GunMetalDk sm:px-10 xl:p-12">
              ...
              <div class="hidden absolute top-0 right-0 bottom-0 w-1/2 pointer-events-none lg:block" aria-hidden="true">
                <svg class="absolute inset-0 w-full h-full text-orange-500 dark:text-GunMetalLt" width="160" height="678" viewBox="0 0 160 678"
                     fill="none" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 class="font-futura text-lg font-medium text-GunMetal dark:text-white">Contact information</h3>
              <p class="mt-6 text-base dark:text-gray-200 text-gray-500 max-w-3xl">Questions? How can we help? Please reach out to us.</p>
              <dl class="mt-8 space-y-6">
                <dt><span class="sr-only">Phone number</span></dt>
                <dd class="flex text-base dark:text-gray-100 text-gray-600">
                  <PhoneIcon class="flex-shrink-0 w-6 h-6 dark:text-gray-200 text-gray-500" aria-hidden="true" />
                  <span class="ml-3">+1 (917) 887-1295</span>
                </dd>
                <dt><span class="sr-only">Email</span></dt>
                <dd class="flex text-base dark:text-gray-100 text-gray-600">
                  <MailIcon class="flex-shrink-0 w-6 h-6 dark:text-gray-200 text-gray-500" aria-hidden="true" />
              ...
              <ul role="list" class="mt-8 flex space-x-6">
                <li>
                  <a>
                    ...
                    <LinkedInLogoIcon class="h-6 w-6 text-GunMetal dark:text-gray-200 hover:text-Linkedin dark:hover:text-Linkedin"
                ...
                <li>
                  <a>
                    ...
                    <MediumLogoIcon class="h-6 w-6 text-GunMetal dark:text-gray-200 hover-text-gray-400 hover-dark:text-black"
            ...
            <!-- Contact form -->
            <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12 bg-gray-100 dark:bg-white">
...
<g>
<rect x="7.28" y="45.637" width="76.651" height="8.333" />
  <path
    d="M86.81,44.047l-27.998,27.998l5.893,5.892l27.997,-27.998l-5.892,-5.892Z" />
  <path
