...
export default {
  ...
  data() {
    return {
      solutionImage: 'kpi-strategy-design',
      solutionTitle: 'KPI Strategy',
      ...
      kpiDesignOne:
        {
          ...
          text: 'An interactive process iteratively cycling through the three layers below until each KPI is validated and optimized: ',
