...
<!--            Popover-->
<!--            <div class='relative' v-slot='{ open }'>-->
            <div class='relative'>
<!--              PopoverButton-->
              <button
                @click='isOpen = !isOpen'
                :class="[isOpen ? 'text-gray-900' : 'text-gray-500', 'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500']">
                <span>Solutions</span>
                <v-icon name='chevron-down'
                  :class="[isOpen ? 'text-gray-600' : 'text-gray-400', 'ml-2 h-5 w-5 group-hover:text-gray-500']"
                  aria-hidden='true' />
              </button>
                    ...
                    <div class='relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2'>
                      <a v-for='item in solutions' :key='item.name' :href='item.href'
                        ...
                        <div
                          ...
                          <v-icon :name='item.icon' class='h-6 w-6' aria-hidden='true' />
                        </div>
                        <div class='ml-4'>
...
<!--          PopoverPanel-->
<!--          <div focus class='absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden'>-->
...
<!--                    PopoverButtton-->
                    <button
                      ...
                      <v-icon name='x' class='h-6 w-6' aria-hidden='true' />
                    </button>
                  </div>
                </div>
                <div class='mt-6'>
