    ...
    <div class='lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24'>
      <div class='px-4 max-w-xl mx-auto sm:px-6 lg:max-w-none lg:mx-0 lg:px-0' :class='contentPlacement'>
        <div>
          <div class='mt-6'>
            <h2 data-aos='fade-up'
                class='font-futura text-3xl font-extrabold tracking-tight text-gray-900 dark:text-gray-200'>
              {{ mainContent.title }}
            </h2>
            ...
            <ul v-if="mainContent.tag==='li'">
              <component :is='mainContent.tag' v-if='mainContent.text2' data-aos='fade-up' :class='listClasses'
                         class='mt-4 text-lg text-gray-500 dark:text-gray-400'>
                {{ mainContent.text2 }}
              </component>
              <component :is='mainContent.tag' v-if='mainContent.text3' data-aos='fade-up' :class='listClasses'
                         class='mt-4 text-lg text-gray-500 dark:text-gray-400'>
                {{ mainContent.text3 }}
              </component>
              <component :is='mainContent.tag' v-if='mainContent.text4' data-aos='fade-up' :class='listClasses'
                         class='mt-4 text-lg text-gray-500 dark:text-gray-400'>
                {{ mainContent.text4 }}
              </component>
            </ul>
