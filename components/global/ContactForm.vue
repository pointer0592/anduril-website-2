          ...
          <div>
            <div>
              <div class="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                <h2 class="text-4xl font-extrabold tracking-tight xs:text-6xl sm:text-6xl text-GunMetalDk dark:text-white">
                  Let's Connect
                </h2>
                <p class="mt-4 text-lg text-gray-500 font-medium dark:text-gray-300 sm:mt-3">
                ...
                >
                  ...
                  >
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                      <div v-if="contact.icon" class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <v-icon :name="contact.icon" class="h-5 w-5 font-medium text-gray-300" aria-hidden="true" />
                      </div>
                      <input
                        :id="contact.name"
                        class="text-gray-300"
                  ...
                  <div class="text-right sm:col-span-2">
                    <button type="submit" class="ml-auto flex justify-center items-center text-orange-500 hover:text-orange-600 pt-6">
                      <span class="text-2xl font-bold">Ship it</span><right-arrow class="h-6 w-auto mb-1"/>
                    </button>
                  </div>
                </form>
              </div>
