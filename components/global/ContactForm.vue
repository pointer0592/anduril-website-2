          ...
          <div>
            <div>
              <div class='max-w-md mx-auto sm:max-w-lg lg:mx-0'>
                <h2 data-aos='fade-up'
                    class='font-futura text-4xl font-extrabold tracking-tight xs:text-6xl sm:text-6xl text-GunMetalDk dark:text-white'>
                  Let's Connect
                </h2>
                  ...
                  >
                    <div v-if='!contact.visibility' class='flex justify-between pt-6'>
                      <label :for='contact.name'
                             class='block text-sm font-medium text-GunMetal dark:text-gray-200'>
{{ contact.header
                        }}
</label>
                      <span v-if='!contact.required' :id='contact.id'
                            class='text-sm font-medium text-GunMetal dark:text-gray-200'>
Optional
</span>
                    </div>
                    <div class='mt-1 relative rounded-md shadow-sm'>
                      <div v-if='contact.icon'
                           class='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
                        <component :is='contact.icon' class='h-5 w-5 font-medium text-gray-400' aria-hidden='true' />
                      </div>
                      <input
                        :id='contact.id'
                        class='text-gray-300'
                  ...
                  <div class='sm:col-span-2 pt-6'>
                    <div class='flex justify-between'>
                      <label for='how-can-we-help-you'
                             class='block text-sm font-medium text-GunMetal dark:text-gray-200'>
How can we help
                        you?
</label>
                      <span id='how-can-we-help-you-optional'
                            class='text-sm font-medium text-GunMetal dark:text-gray-200'>
Optional
</span>
                    </div>
        ...
        <div class='sm:mx-auto sm:max-w-3xl sm:px-6'>
          <div class='py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2'>
            <div class='hidden sm:block'>
              <div class='absolute inset-y-0 left-1/2 w-screen bg-gray-200 rounded-l-xl lg:left-80 lg:right-0 lg:w-full'
                   data-aos='fade-left' />
              <svg class='absolute top-8 right-1/2 -mr-3 lg:m-0 lg:left-0' width='404' height='392' fill='none'
                   viewBox='0 0 404 392' data-aos='fade-up'>
                <defs>
                  <pattern
            ...
            <div data-aos='fade-up-left'
              ...
              <img
                ...
                src='https://res.cloudinary.com/www-andurilpartners-ai/image/upload/v1630611256/contact-section/contact.jpg'
                alt='contact_img'>
            </div>
          </div>
        </div>
