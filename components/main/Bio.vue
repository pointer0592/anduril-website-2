  ...
  <li>
    <div class='space-y-4'>
      ...
      <div class='space-y-2'>
        ...
        <div class='text-sm font-semibold text-gray-800 dark:text-white leading-6 font-medium space-y-1'
             data-aos='fade-up'>
          <p>
            {{ bio.intro | truncate(200) }}
          </p>
          <nuxt-link :to='`/about/${bio.slug}`'>
            <p class='text-base text-gray-500 dark:text-gray-200 underline hover:text-gray-600 dark-hover:text-gray-300'
               data-aos='fade-up'>
              more...
            </p>
          </nuxt-link>
...
import BookOpenIcon from '~/assets/svg/book-open.svg?inline'
